...
# Neue Liste erstellen mit gefilterten Elementen
if "filtered_list" not in st.session_state:
    st.session_state.filtered_list = [
    el for el in st.session_state.db_entries if "overview_pages" in el and "checked" not in el
]
...
if get_event_data:
    ...
    for el in st.session_state.filtered_list:
        ...
        for overview_url in el["overview_pages"]:
            ...
            st.subheader(f"Überprüfe Übersichtsseite: {overview_url}")
